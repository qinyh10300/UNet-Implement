...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, base_channels=32):
        ...
        self.down_block3 = DownBlock(n_channels*2, base_channels*4)
        self.down_block4 = DownBlock(n_channels*4, base_channels*8)

        self.bottom_block = DoubleConv(base_channels*8, base_channels*16)

        self.up_block1 = UpBlock(base_channels*16, base_channels*8)
        self.up_block1 = UpBlock(base_channels*8, base_channels*4)
        self.up_block1 = UpBlock(base_channels*4, base_channels*2)
        self.up_block1 = UpBlock(base_channels*2, base_channels)
